...
public class WLQ_U extends WLQ_BASE {
    ...
    public static int pdmChannel1_INDEX = 38;
    public static int pdmChannel2_INDEX = 39;
    public static int pdmChannel3_INDEX = 40;
    public static int pdmChannel4_INDEX = 41;
