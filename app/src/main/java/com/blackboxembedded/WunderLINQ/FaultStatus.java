...
public class FaultStatus extends ContextWrapper {
    ...
    private static boolean ascFaultActive = false;
    private static String ascFaultDesc = "";
    ...
    public FaultStatus(Context base) {
        ...
        ascFaultDesc = MainActivity.getContext().getResources().getString(R.string.fault_ASCF);
    ...
    public static ArrayList<String> getallActiveDesc() {
        ...
        if(ascFaultActive){
            allActiveDesc.add(ascFaultDesc);
        }
        if(fuelFaultActive){
    ...
    public static void setascFaultActive(boolean ascFaultActive){
        FaultStatus.ascFaultActive = ascFaultActive;
    }
    public static boolean getascFaultActive() {
        return ascFaultActive;
    }
    public static String getascFaultDesc() {
        return ascFaultDesc;
    }
