...
public class GattAttributes {
    ...
    public static final String WUNDERLINQ_S_COMMAND_CHARACTERISTIC = "00000004-0000-1000-8000-00805f9b34fc";
    ...
    static {
        ...
        attributesUUID.put(UUIDDatabase.UUID_WUNDERLINQ_S_COMMAND_CHARACTERISTIC, "WunderLINQ S Commands");
