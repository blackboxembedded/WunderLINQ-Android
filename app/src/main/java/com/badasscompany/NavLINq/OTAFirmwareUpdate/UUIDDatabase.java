...
import com.badasscompany.NavLINq.GattAttributes;
...
public class UUIDDatabase {
    ...
    /**
     * NavLINq related UUID
     */
    public final static UUID UUID_NAVLINQ_SERVICE = UUID
            .fromString(GattAttributes.MOTORCYCLE_SERVICE);
    public final static UUID UUID_NAVLINQ_MESSAGE_CHARACTERISTIC = UUID
            .fromString(GattAttributes.LIN_MESSAGE_CHARACTERISTIC);
    public final static UUID UUID_NAVLINQ_DFU_CHARACTERISTIC = UUID
