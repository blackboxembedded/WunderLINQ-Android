...
public class PhotoService extends Service {
    protected static final String TAG = "NavLINq";
    ...
    private void processImage(Image image){
        ...
        buffer.get(bytes);
        File root = new File(Environment.getExternalStorageDirectory(), "/NavLINq/photos/");
        if(!root.exists()){
            if(!root.mkdirs()){
    ...
    private void saveImageToDisk(final byte[] bytes) {
        ...
        final File file = new File(Environment.getExternalStorageDirectory() + "/NavLINq/photos/"
                + "NavLINq-Photo-" + DateFormat.format("yyyy-MM-dd_kk-mm-ss", new Date().getTime()) + ".jpg");
